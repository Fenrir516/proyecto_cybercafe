...
<body>
     <div class="container">
         ...
         <form action="insertar.php" method="POST">
            ...
            <input type="text" class="form-control mb-3" name="Gabinete" placeholder="Gabinete">
            <input type="text" class="form-control mb-3" name="Refigeracion" placeholder="Refigeracion">
             ...
             <tbody>
                 ...
                 while($row=mysqli_fetch_array($query)){
                   ...
                   <tr>
                        ...
                        <th><?php echo $row['Gabinete']?></th>
                        <th><?php echo $row['Refigeracion']?></th>
